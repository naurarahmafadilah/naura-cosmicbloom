...
const SaleDetail = () => {
  ...
  const product = saleData.find((p) => p.slug === slug);
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-5 mb-8">
            <div className="flex flex-col">
                ...
                <span className="text-2xl text-secondary-dark/30 line-through font-quicksand">Rp {product.oldPrice}</span>
            </div>
            <div className="flex flex-col">
          ...
          <p className="text-secondary-dark/70 leading-relaxed mb-8 italic font-quicksand text-lg">
            "Dapatkan koleksi premium Veloura dengan harga spesial musim ini. Stok sangat terbatas, pastikan Anda tidak melewatkannya."
          </p>
          
          <div className="space-y-4 mb-10">
            <div className="flex items-center gap-3 text-sm text-secondary-dark/80 font-quicksand">
              <FaCheckCircle className="text-secondary-light" /> Produk Original & Berkualitas
            </div>
            <div className="flex items-center gap-3 text-sm text-secondary-dark/80 font-quicksand">
